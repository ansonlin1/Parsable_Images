...
if not os.path.isdir(os.path.join(expanduser("~"), "Desktop", "PythonImages")):
	os.mkdir(os.path.join(expanduser("~"), "Desktop", "PythonImages"))

# Create Log File
logFile = os.path.join(expanduser("~"), "Desktop", "PythonImages", "LogFile.log")
...
class Parsable():
	def __init__(self):
		...
		# List of templates. [Near Miss Template]
		# TODO: Update Near Miss Template ID
